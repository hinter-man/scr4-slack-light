            ...
            <div id="<?php echo $posting->getId(); ?>"
                ...
                <div class="row">
                    ...
                    <div align="right" class="col-sm-3">
                        <div id="update-posting-buttons"
                             class="content-inline
                             <?php print \Slack\Util::hidePostingButtons($user, $posting) ? 'hide-posting-buttons' : ''; ?>">
                            ...
                            <button id="edit-posting-btn-<?php echo $posting->getId(); ?>"
                                    class="posting-buttons edit-posting-btn" data-toggle="modal"
                                    data-target="#edit-posting-modal"
